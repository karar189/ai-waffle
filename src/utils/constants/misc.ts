...
export const PROCESS = [
    {
        title: "Enter your trade intent",
        description: "Describe your idea. AI structures risk, targets, and position sizing.",
        icon: FolderOpenIcon,
    },
    {
        title: "AI structures your plan",
        description: "Get a clear, risk-aware trade plan with entry, targets, and stops.",
        icon: WandSparklesIcon,
    },
    {
        title: "Execute with clarity",
        description: "Use checklists and simulation before you commit capital.",
        icon: BarChart3Icon,
    },
] as const;
